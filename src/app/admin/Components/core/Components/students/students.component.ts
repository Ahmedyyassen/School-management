...
// ****************************
const modulses = [ReactiveFormsModule,FormsModule,MatTableModule, MatPaginatorModule,FormsModule,MatFormFieldModule, MatInputModule,CommonModule]
@Component({
...
export class StudentsComponent implements OnDestroy,AfterViewInit {
  sreach : string = "";
